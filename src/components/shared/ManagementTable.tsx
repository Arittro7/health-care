...
export interface Column<T>{
  ...
  className ?: string //to use custom cell color on Table 
}

interface ManagementTableProps<T>{
  data: T[] //accessor will add based on data
  columns: Column<T>[]
  onView ?: (row : T) =>void 
  onEdit ?: (row : T) =>void
  onDelete ?: (row : T) =>void
...
/*
1. Define the props which will required for the management table
*/