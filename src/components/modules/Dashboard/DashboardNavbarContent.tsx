...
const DashboardNavbarContent = ({ userInfo, navItems, dashboardHome }: DashboardNavbarContentProps) => {
  //To make the Mobile Sidebar(Sheet Component) hidden during full screen
  const [isOpen, setIsOpen] =useState(false)
  const [isMobile, setIsMobile] = useState(false)

  // checking mobile screen
  useEffect(() => {
...
/*
I will pass the Nav items and Dashboard home as Props to the dashboardSidebar
*/
